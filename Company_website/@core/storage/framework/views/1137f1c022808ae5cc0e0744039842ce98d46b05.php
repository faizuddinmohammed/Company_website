            ...
            <div class="card">
                <div class="card-body">
                    <div class="header-wrap d-flex justify-content-between">
                        <h4 class="header-title"><?php echo e(__('New Solution')); ?></h4>
                        <a href="<?php echo e(route('admin.solutions')); ?>" class="btn btn-primary"><?php echo e(__('All Solutions')); ?></a>
                    </div>

                    <form action="<?php echo e(route('admin.solutions')); ?>" method="post" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="form-group">
                            <label for="excerpt"><?php echo e(__('Title 1')); ?></label>
                            <textarea name="excerpt" id="excerpt" class="form-control max-height-150" placeholder="<?php echo e(__('Title 1')); ?>" cols="30" rows="10"></textarea>
                            
                        </div>
                        <div class="form-group">
                            <label for="description"><?php echo e(__('Description 1')); ?></label>
                            <input type="hidden" name="description" id="description">
                            <div class="summernote"></div>
                        </div>

                        <div class="form-group">
                            <label for="excerpt2"><?php echo e(__('Title 2')); ?></label>
                            <textarea name="excerpt2" id="excerpt2" class="form-control max-height-150" placeholder="<?php echo e(__('Title 2')); ?>" cols="30" rows="10"></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="text2" id="text2" class="form-control max-height-150" placeholder="<?php echo e(__('Heading Middle')); ?>" cols="30" rows="10"></textarea>
                        </div>
                        <div class="form-group">
                            <label for="text1"><?php echo e(__('Text Bottom')); ?></label>
                            <textarea name="text1" id="text1" class="form-control max-height-150" placeholder="<?php echo e(__('Text Bottom')); ?>" cols="30" rows="10"></textarea>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <span class="info-text"><?php echo e(__('if you set order for it, all solution will show in frontend as a per this order')); ?></span>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="media-upload-btn-wrapper">
                                ...
                                <button type="button" class="btn btn-info media_upload_form_btn" data-btntitle="<?php echo e(__('Select Solution Image')); ?>" data-modaltitle="<?php echo e(__('Upload Solution Image')); ?>" data-toggle="modal" data-target="#media_upload_modal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="media-upload-btn-wrapper">
                                ...
                                <button type="button" class="btn btn-info media_upload_form_btn" data-btntitle="<?php echo e(__('Select Solution Banner')); ?>" data-modaltitle="<?php echo e(__('Upload Solution Banner')); ?>" data-toggle="modal" data-target="#media_upload_modal">
                                    <?php echo e(__('Upload Banner')); ?>

                                </button>
                            </div>
                            <small><?php echo e(__('Recommended image size 3000x1688')); ?></small>
                        </div>
...
<script>
    $(document).ready(function() {
        ...
        $(document).on('change', '#language', function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('admin.solutions.category.by.slug')); ?>",
                type: "POST",
                data: {
            ...
            $.ajax({
                url: "<?php echo e(route('admin.solutions.price.plan.by.slug')); ?>",
                type: "POST",
                data: {
                    _token: "<?php echo e(csrf_token()); ?>",
                    lang: selectedLang
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/19b/5/5cebb17d2b/public_html/@core/resources/views/backend/pages/solution/new-service.blade.php ENDPATH**/ ?>