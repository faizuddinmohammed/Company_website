<?php $__env->startSection('site-title'); ?>
    <?php echo e(__('Service Query Form Builder')); ?>
    ...
    <div class="col-lg-12 col-ml-12 padding-bottom-30">
        <div class="row">
            ...
            <div class="col-lg-6 mt-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title"><?php echo e(__("Service Query Form Builder")); ?></h4>
                        <form action="<?php echo e(route('admin.form.builder.service.query')); ?>" method="Post">
                            <?php echo csrf_field(); ?>
                            <?php echo render_drag_drop_form_builder_markup(get_static_option('service_query_form_fields')); ?>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/19b/5/5cebb17d2b/public_html/@core/resources/views/backend/form-builder/service-query-form.blade.php ENDPATH**/ ?>