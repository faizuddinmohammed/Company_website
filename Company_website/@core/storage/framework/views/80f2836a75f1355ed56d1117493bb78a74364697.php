    ...
    <div class="col-lg-12 col-ml-12 padding-bottom-30">
        <div class="row">
            ...
            <div class="col-lg-12 mt-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title"><?php echo e(__('Solution Items')); ?></h4>
                                    ...
                                    <div class="table-wrap table-responsive">
                                        ...
                                        <?php $__currentLoopData = $service; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                               ...
                                               <form method='post' action='<?php echo e(route('admin.solutions.delete',$data->id)); ?>'>
                                               ...
                                               <br>
                                                ...
                                                ">
                                                    ...
                                                    <a href="<?php echo e(route('admin.solutions.edit',$data->id)); ?>" class="btn btn-lg btn-primary btn-xs mb-3 mr-1">
                                                        <i class="ti-pencil"></i>
                                                    </a>
                                                    <br>
                                                    ...
                                                    <form action="<?php echo e(route('admin.solutions.clone')); ?>" method="post" style="display: inline-block">
                                                        <?php echo csrf_field(); ?>
        ...
        $(document).ready(function () {
            ...
            $(document).on('click','#bulk_delete_btn',function (e) {
                ...
                if(allIds != '' && bulkOption == 'delete'){
                    ...
                    $.ajax({
                        'type' : "POST",
                        'url' : "<?php echo e(route('admin.solutions.bulk.action')); ?>",
                        'data' : {
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/19b/5/5cebb17d2b/public_html/@core/resources/views/backend/pages/solution/index.blade.php ENDPATH**/ ?>