                        ...
                        <div class="gig-chat-message-heading">
                            ...
                            <div class="gig-order-info">
                                <ul>
                                    ...
                                    <li><strong><?php echo e(__('User:')); ?></strong> <?php echo e($ticket_details->user->name ?? __('anonymous')); ?></li>
                                    <li><strong><?php echo e(__('Department:')); ?></strong> <?php echo e($ticket_details->department->name ?? __('anonymous')); ?></li>
                                    <?php if($ticket_details->admin_id): ?>
                                        <li><strong><?php echo e(__('Admin:')); ?></strong> <?php echo e($ticket_details->admin->name ?? __('anonymous')); ?></li>
                                    <?php endif; ?>
                                </ul>
                            </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/19b/5/5cebb17d2b/public_html/@core/resources/views/backend/support-ticket/view-ticket.blade.php ENDPATH**/ ?>