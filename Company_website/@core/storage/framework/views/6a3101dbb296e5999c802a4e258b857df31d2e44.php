        ...
        <div class="menu-inner">
            <nav id="main_menu_wrap">
                <ul class="metismenu" id="menu">
                    ...
                    <?php if(check_page_permission_by_string('Solutions')): ?>
                    
                    <li class="main_dropdown
                    <?php if(request()->is(['admin-home/solutions/*','admin-home/solutions'])): ?> active <?php endif; ?>
                    ">
                        <a href="javascript:void(0)"
                           aria-expanded="true">
                            <i class="ti-layout"></i>
                            <span><?php echo e(__('solutions')); ?></span>
                        </a>
                        <ul class="collapse">
                            <li class="<?php echo e(active_menu('admin-home/solutions')); ?>"><a
                                    href="<?php echo e(route('admin.solutions')); ?>"><?php echo e(__('All Solutions')); ?></a></li>
                            <li class="<?php echo e(active_menu('admin-home/solutions/new')); ?>"><a
                                    href="<?php echo e(route('admin.solutions.new')); ?>"><?php echo e(__('New Solution')); ?></a></li>
                            <li class="<?php echo e(active_menu('admin-home/solutions/category')); ?>"><a
                                    href="<?php echo e(route('admin.solutions.category')); ?>"><?php echo e(__('Category')); ?></a></li>
                            <li class="<?php echo e(active_menu('admin-home/solutions/page-settings')); ?>"><a
                                    href="<?php echo e(route('admin.solutions.page.settings')); ?>"><?php echo e(__('Solution Page')); ?></a></li>
...
<?php /**PATH /home/sites/19b/5/5cebb17d2b/public_html/@core/resources/views/backend/partials/sidebar.blade.php ENDPATH**/ ?>