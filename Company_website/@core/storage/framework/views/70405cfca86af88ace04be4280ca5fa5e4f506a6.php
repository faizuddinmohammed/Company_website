                        ...
                        <form action="<?php echo e(route('admin.quote.page')); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="tab-content margin-top-30" id="nav-tabContent">
                                ...
                                <div class="tab-pane fade <?php if($key == 0): ?> show active <?php endif; ?>" id="nav-home-<?php echo e($lang->slug); ?>" role="tabpanel" >
                                    ...
                                    <div class="form-group">
                                        <label for="quote_page_<?php echo e($lang->slug); ?>_form_button_text"><?php echo e(__('Quote Form Button Text')); ?></label>
                                        <input type="text" name="quote_page_<?php echo e($lang->slug); ?>_form_button_text" value="<?php echo e(get_static_option('quote_page_'.$lang->slug.'_form_button_text')); ?>" class="form-control" id="quote_page_<?php echo e($lang->slug); ?>_form_button_text">
                                    </div>
                                </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/19b/5/5cebb17d2b/public_html/@core/resources/views/backend/quote-manage/quote-page-manage.blade.php ENDPATH**/ ?>