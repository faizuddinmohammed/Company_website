...
<?php $__env->startSection('page-meta-data'); ?>
    <meta name="description"
        content="<?php echo e(get_static_option('work_page' . $user_select_lang_slug . '_meta_description')); ?>">
    <meta name="tags" content="<?php echo e(get_static_option('work_page' . $user_select_lang_slug . '_meta_tags')); ?>">
<?php $__env->stopSection(); ?>
            ...
            <div class="row">
                <div class="service-banner">
                    <div class="banner-inner">
                        ...
                        <div class="page-desc"><p>Techstudio provides customized, flexible, reliable managed service solutions. With Wachter as your managed services provider, youll stop worrying about your technology and start focusing on your business.</p></div>
                    </div>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/19b/5/5cebb17d2b/public_html/@core/resources/views/frontend/pages/solution/services.blade.php ENDPATH**/ ?>