            ...
            <div class="card">
                <div class="card-body">
                    <div class="header-wrap d-flex justify-content-between">
                        <h4 class="header-title"><?php echo e(__('Edit Solution')); ?></h4>
                        <a href="<?php echo e(route('admin.solutions')); ?>" class="btn btn-primary"><?php echo e(__('All Solutions')); ?></a>
                    </div>
                    <form action="<?php echo e(route('admin.solutions.update')); ?>" method="post" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
<?php endif; ?>  
                        ...
                        <button type="submit" class="btn btn-primary mt-4 pr-4 pl-4"><?php echo e(__('Update Solution')); ?></button>
                    </form>
                </div>
            </div>
        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/19b/5/5cebb17d2b/public_html/@core/resources/views/backend/pages/solution/edit-service.blade.php ENDPATH**/ ?>