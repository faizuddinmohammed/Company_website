...
<?php endif; ?> 
            ...
            <div class="col-lg-12 mt-t">
                <div class="card margin-bottom-30">
                    <div class="card-body">
                        <h4 class="header-title"><?php echo e(__('Home Page Builder settings')); ?></h4>
                        <div class="alert alert-info"><?php echo e(__('if you enable page builder, your home page will load only page builder content.')); ?></div>
                        
                        <form action="<?php echo e(route('admin.home.page.builder')); ?>" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="form-group">
                                <label for="home_page_page_builder_status"><strong><?php echo e(__('Enable/Disable Page Builder For Home Page')); ?></strong></label>
                                <label class="switch">
                                    <input type="checkbox" name="home_page_page_builder_status"
                                           <?php if(!empty(get_static_option('home_page_page_builder_status'))): ?> checked <?php endif; ?> >
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div id="page-builder-wrap"
                             class="margin-top-50 page-builder-content-wrap <?php if(get_static_option('home_page_page_builder_status')): ?> d-block <?php else: ?> d-none <?php endif; ?>">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="page-builder-area-wrapper">
                                        <ul id="sortable"
                                            class="sortable available-form-field main-fields sortable_widget_location">
                                            <?php echo \App\PageBuilder\PageBuilderSetup::get_saved_addons_by_location('homepage'); ?>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/19b/5/5cebb17d2b/public_html/@core/resources/views/backend/page-builder/homepage.blade.php ENDPATH**/ ?>