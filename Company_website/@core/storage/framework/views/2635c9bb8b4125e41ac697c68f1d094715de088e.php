                ...
                <div class="card">
                    <div class="card-body">
                        <div class="header-wrap d-flex justify-content-between">
                            <h4 class="header-title"><?php echo e(__('Add New Popup')); ?></h4>
                            <a href="<?php echo e(route('admin.popup.builder.all')); ?>" class="btn btn-primary"><?php echo e(__('All Popup')); ?></a>
                        </div>
                        <form action="<?php echo e(route('admin.popup.builder.new')); ?>" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"  id="name" name="name" value="<?php echo e(old('name')); ?>" placeholder="<?php echo e(__('Name')); ?>">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="type" id="popup_type" class="form-control">
                                                ...
                                                <option value="only_image"><?php echo e(__('Only Image')); ?></option>
                                                <option value="promotion"><?php echo e(__('Promotion')); ?></option>
                                                <option value="discount"><?php echo e(__('Discount')); ?></option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <label for="description"><?php echo e(__('Description')); ?></label>
                                        <textarea name="description" id="description" class="form-control" cols="30" rows="10" placeholder="<?php echo e(__('Description')); ?>"></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="offer_time_end"><?php echo e(__('Offer End Date')); ?></label>
                                        <input type="date" class="form-control datepicker"  id="offer_time_end" name="offer_time_end" placeholder="<?php echo e(__('offer end date')); ?>">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"  id="button_text" name="button_text" value="<?php echo e(old('button_text')); ?>" placeholder="<?php echo e(__('Button Text')); ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="button_link"><?php echo e(__('Button Link')); ?></label>
                                        <input type="text" class="form-control"  id="button_link" name="button_link" value="<?php echo e(old('button_link')); ?>" placeholder="<?php echo e(__('Button Link')); ?>">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <button type="submit" class="btn btn-primary mt-4 pr-4 pl-4"><?php echo e(__('Add New Popup')); ?></button>
                                </div>
                            </div>
                        </form>
                    </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/19b/5/5cebb17d2b/public_html/@core/resources/views/backend/popup-builder/popup-new.blade.php ENDPATH**/ ?>