            ...
            <div class="col-lg-6">
                <div class="service-item-wrapper">
                    <div class="single-service-item">
                        ...
                        <div class="service-text">
                            <div class="service-text-inner">
                                <h2 class="title"><?php echo e(filter_static_option_value('home_page_01_'.$user_select_lang_slug.'_about_us_our_mission_title',$static_field_data)); ?></h2>
                    ...
                    <div class="single-service-item">
                        <div class="service-text">
                            <div class="service-text-inner">
                                <h2 class="title"><?php echo e(filter_static_option_value('home_page_01_'.$user_select_lang_slug.'_about_us_our_vision_title',$static_field_data)); ?></h2>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="experience-author bg-image"
                   <?php echo render_background_image_markup_by_attachment_id(filter_static_option_value('home_page_04_quality_area_image',$static_field_data)); ?>
            ...
            <div class="col-lg-5 offset-lg-1 p-0">
                <div class="experience-content-03 section-padding">
                    <div class="content">
                        <h2 class="title"><?php echo e(filter_static_option_value('home_page_01_'.$user_select_lang_slug.'_quality_area_title',$static_field_data)); ?></h2>
                        ...
                        <div class="servicee-area">
                            <ul>
                                ...
                                ?>
                                <?php $__currentLoopData = $bullet_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($item): ?>
                                    <li>
                                        <i class="fas fa-check-circle"></i> <?php echo e($item); ?>
...
<?php if(!empty(filter_static_option_value('home_page_case_study_section_status',$static_field_data))): ?>
    <div class="case-studies-area-03  padding-bottom-120">
        <div class="container">
            ...
            <div class="row">
                <?php $a = 1; ?>
                <?php if(filter_static_option_value('home_page_01_work_area_item_type',$static_field_data) === 'category'): ?>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-what-we-cover-item style-01 margin-bottom-30">
                        ...
                        <div class="content">
                            <h4 class="title">
                                <a href="<?php echo e(route('frontend.works.category',[ 'id' => $data->id , 'any' => Str::slug($data->name)])); ?>"><?php echo e($data->name); ?></a>
                            </h4>
                        </div>
                    </div>
                </div>
...
<?php if(!empty(filter_static_option_value('home_page_testimonial_section_status',$static_field_data))): ?>
    <section class="testimonial-area bg-image-01 padding-top-110 padding-bottom-115"
             <?php echo render_background_image_markup_by_attachment_id(filter_static_option_value('home_03_testimonial_bg',$static_field_data)); ?>
...
<?php /**PATH /home/sites/19b/5/5cebb17d2b/public_html/@core/resources/views/frontend/home-pages/home-04.blade.php ENDPATH**/ ?>