...
Route::group(['middleware' => ['setlang:frontend', 'globalVariable', 'maintains_mode', 'HtmlMinifier']], function () {
    ...
    //Route::get('services', 'FrontendController@services_page');
    /*--------------------------------------
...
Route::prefix('admin-home')->middleware(['setlang:backend'])->group(function () {
    ...
    /*==============================================
          SOLUTIONS MODULE
    ==============================================*/
    Route::prefix('solutions')->middleware(['adminPermissionCheck:Solutions'])->group(function () {
        /*-----------------------------------
         SOLUTIONS MODULE : SOLUTIONS ROUTES
        ------------------------------------*/
        Route::get('/', 'SolutionController@index')->name('admin.solutions');
        Route::post('/', 'SolutionController@store');
        Route::get('/new', 'SolutionController@new_solution')->name('admin.solutions.new');
        Route::get('/edit/{id}', 'SolutionController@edit_solution')->name('admin.solutions.edit');
        Route::post('/cat-by-slug', 'SolutionController@category_by_slug')->name('admin.solutions.category.by.slug');
        Route::post('/price-plan-by-slug', 'SolutionController@price_plan_by_slug')->name('admin.solutions.price.plan.by.slug');
        Route::post('/update', 'SolutionController@update')->name('admin.solutions.update');
        Route::post('/clone', 'SolutionController@clone_solution_as_draft')->name('admin.solutions.clone');
        Route::post('/bulk-action', 'SolutionController@bulk_action')->name('admin.solutions.bulk.action');
        Route::post('/delete/{id}', 'SolutionController@delete')->name('admin.solutions.delete');
        /*-----------------------------------
            SOLUTIONS MODULE : CATEGORY ROUTES
         ------------------------------------*/
        Route::group(['prefix' => 'category' ],function (){
            Route::get('/', 'SolutionController@category_index')->name('admin.solutions.category');
            Route::post('/', 'SolutionController@category_store');
            Route::post('/update', 'SolutionController@category_update')->name('admin.solutions.category.update');
            Route::post('/delete/{id}', 'SolutionController@category_delete')->name('admin.solutions.category.delete');
            Route::post('/bulk-action', 'SolutionController@category_bulk_action')->name('admin.solutions.category.bulk.action');
        });


        /*-----------------------------------
             SOLUTIONS MODULE : PAGE SETTINGS ROUTES
       ------------------------------------*/
        Route::get('/page-settings', 'SolutionPageController@solution_page_settings')->name('admin.solutions.page.settings');
        Route::post('/page-settings', 'SolutionPageController@update_solution_page_settings');
