    ...
    <div class="col-lg-12 col-ml-12 padding-bottom-30">
        <div class="row">
            ...
            <div class="col-lg-12 mt-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">{{__('Solution Items')}}</h4>
                                    ...
                                    <div class="table-wrap table-responsive">
                                        ...
                                        @foreach($service as $data)
                                            <tr>
                                               ...
                                               <form method='post' action='{{route('admin.solutions.delete',$data->id)}}'>
                                               ...
                                               <br>
                                                ...
                                                ">
                                                    ...
                                                    <a href="{{route('admin.solutions.edit',$data->id)}}" class="btn btn-lg btn-primary btn-xs mb-3 mr-1">
                                                        <i class="ti-pencil"></i>
                                                    </a>
                                                    <br>
                                                    ...
                                                    <form action="{{route('admin.solutions.clone')}}" method="post" style="display: inline-block">
                                                        @csrf
        ...
        $(document).ready(function () {
            ...
            $(document).on('click','#bulk_delete_btn',function (e) {
                ...
                if(allIds != '' && bulkOption == 'delete'){
                    ...
                    $.ajax({
                        'type' : "POST",
                        'url' : "{{route('admin.solutions.bulk.action')}}",
                        'data' : {
                            _token: "{{csrf_token()}}",
                            ids: allIds
                        },
