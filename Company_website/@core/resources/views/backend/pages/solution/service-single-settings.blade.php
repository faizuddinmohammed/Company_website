    ...
    <div class="col-lg-12 col-ml-12 padding-bottom-30">
        <div class="row">
            <div class="col-12 mt-5">
                ...
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">{{__("Solution Single Settings")}}</h4>
                        <form action="{{route('admin.solutions.single.page.settings')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <nav>
