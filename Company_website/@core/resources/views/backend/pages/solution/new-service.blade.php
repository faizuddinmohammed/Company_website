            ...
            <div class="card">
                <div class="card-body">
                    <div class="header-wrap d-flex justify-content-between">
                        <h4 class="header-title">{{__('New Solution')}}</h4>
                        <a href="{{route('admin.solutions')}}" class="btn btn-primary">{{__('All Solutions')}}</a>
                    </div>

                    <form action="{{route('admin.solutions')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="media-upload-btn-wrapper">
                                ...
                                <button type="button" class="btn btn-info media_upload_form_btn" data-btntitle="{{__('Select Solution Image')}}" data-modaltitle="{{__('Upload Solution Image')}}" data-toggle="modal" data-target="#media_upload_modal">
                                    {{__('Upload Image')}}
                                </button>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="media-upload-btn-wrapper">
                                ...
                                <button type="button" class="btn btn-info media_upload_form_btn" data-btntitle="{{__('Select Solution Banner')}}" data-modaltitle="{{__('Upload Solution Banner')}}" data-toggle="modal" data-target="#media_upload_modal">
                                    {{__('Upload Banner')}}
                                </button>
                            </div>
