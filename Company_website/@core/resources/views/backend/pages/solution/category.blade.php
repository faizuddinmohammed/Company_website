                                    ...
                                    <div class="table-wrap table-responsive">
                                        ...
                                        @foreach($category as $data)
                                            <tr>
                                               ...
                                               <form method='post' action='{{route('admin.solutions.category.delete',$data->id)}}'>
            ...
            <div class="col-lg-6 mt-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.solutions.category')}}" method="post" enctype="multipart/form-data">
                            @csrf
    ...
    <div class="modal fade" id="category_edit_modal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{route('admin.solutions.category.update')}}"  method="post">
        ...
        $(document).ready(function () {
            ...
            $(document).on('click','#bulk_delete_btn',function (e) {
                ...
                if(allIds != '' && bulkOption == 'delete'){
                    ...
                    $.ajax({
                        'type' : "POST",
                        'url' : "{{route('admin.solutions.category.bulk.action')}}",
                        'data' : {
                            _token: "{{csrf_token()}}",
                            ids: allIds
                        },
