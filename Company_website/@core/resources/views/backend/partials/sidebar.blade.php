        ...
        <div class="menu-inner">
            <nav id="main_menu_wrap">
                <ul class="metismenu" id="menu">
                    ...
                    @if(check_page_permission_by_string('Solutions'))
                    
                    <li class="main_dropdown
                    @if(request()->is(['admin-home/solutions/*','admin-home/solutions'])) active @endif
                    ">
                        <a href="javascript:void(0)"
                           aria-expanded="true">
                            <i class="ti-layout"></i>
                        ...
                        <ul class="collapse">
                            <li class="{{active_menu('admin-home/solutions')}}"><a
                                    href="{{route('admin.solutions')}}">{{__('All Solutions')}}</a></li>
                            <li class="{{active_menu('admin-home/solutions/new')}}"><a
                                    href="{{route('admin.solutions.new')}}">{{__('New Solution')}}</a></li>
                            <li class="{{active_menu('admin-home/solutions/category')}}"><a
                                    href="{{route('admin.solutions.category')}}">{{__('Category')}}</a></li>
                            <li class="{{active_menu('admin-home/solutions/page-settings')}}"><a
                                    href="{{route('admin.solutions.page.settings')}}">{{__('Solution Page')}}</a></li>
