...
@section('page-meta-data')
    <meta name="description"
        content="{{ get_static_option('work_page' . $user_select_lang_slug . '_meta_description') }}">
    <meta name="tags" content="{{ get_static_option('work_page' . $user_select_lang_slug . '_meta_tags') }}">
@endsection
@section('content')
<style>
